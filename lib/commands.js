...
const commandDefs = [
    ...
    new SlashCommandBuilder()
        .setName('setannounce')
        .setDescription('Set the saved announce message (whitelist only).')
        .addStringOption(option =>
            option
                .setName('text')
                .setDescription('Message the bot will post with /announce')
                .setRequired(true)
        ),

    new SlashCommandBuilder()
        .setName('announce')
        .setDescription('Post the announce message for everyone to see (whitelist only).')
        .addStringOption(option =>
            option
                .setName('text')
                .setDescription('Optional custom text (uses saved announce if omitted)')
                .setRequired(false)
        ),
